...
using System.Data.SqlClient; // para usar sql
...
namespace ABMMascotas
{
    class AccesoDatos
    {
        SqlConnection conexion = new SqlConnection(@"Data Source=DESKTOP-64M431K\SQLEXPRESS;Initial Catalog=veterinaria;Integrated Security=True");
